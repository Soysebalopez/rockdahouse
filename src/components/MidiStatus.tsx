...
const LEARNABLE_ACTIONS: { label: string; action: MidiAction }[] = [
  ...
  { label: 'Deck A FX Brake', action: 'deckA.fxBrake' },
  { label: 'Deck A FX Spin', action: 'deckA.fxSpin' },
  { label: 'Deck A FX Repeat', action: 'deckA.fxRepeat' },
  { label: 'Deck A FX Echo', action: 'deckA.fxEcho' },
  { label: 'Deck A FX Filter', action: 'deckA.fxFilter' },
  ...
  { label: 'Deck B FX Brake', action: 'deckB.fxBrake' },
  { label: 'Deck B FX Spin', action: 'deckB.fxSpin' },
  { label: 'Deck B FX Repeat', action: 'deckB.fxRepeat' },
  { label: 'Deck B FX Echo', action: 'deckB.fxEcho' },
  { label: 'Deck B FX Filter', action: 'deckB.fxFilter' },
  { label: 'Deck C Play', action: 'deckC.play' },
  { label: 'Deck C Volume', action: 'deckC.volume' },
  { label: 'Deck C FX Brake', action: 'deckC.fxBrake' },
  { label: 'Deck C FX Echo', action: 'deckC.fxEcho' },
  { label: 'Deck D Play', action: 'deckD.play' },
  { label: 'Deck D Volume', action: 'deckD.volume' },
  { label: 'Deck D FX Brake', action: 'deckD.fxBrake' },
  { label: 'Deck D FX Echo', action: 'deckD.fxEcho' },
  { label: 'Sampler Pad 1', action: 'sampler.pad1' },
  { label: 'Sampler Pad 2', action: 'sampler.pad2' },
  { label: 'Sampler Pad 3', action: 'sampler.pad3' },
  { label: 'Sampler Pad 4', action: 'sampler.pad4' },
  { label: 'Sampler Pad 5', action: 'sampler.pad5' },
  { label: 'Sampler Pad 6', action: 'sampler.pad6' },
  { label: 'Sampler Pad 7', action: 'sampler.pad7' },
  { label: 'Sampler Pad 8', action: 'sampler.pad8' },
